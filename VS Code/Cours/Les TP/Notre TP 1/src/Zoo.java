...
public class Zoo{
    ...
    private final File file = new File("src\\ressources\\saveFile.txt");
    ...
    public Animal[] trouverAnimauxExtremes(){
        ...
        for (Animal a : map.values()){
            ...
            if (léger == null || léger.getWeight() < a.getWeight()){
                léger = a;
            }
    ...
    public void afficherResumeCompletZoo(){
        ...
        Animal[] légerLourd = trouverAnimauxExtremes();
